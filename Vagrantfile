...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "tsepanik-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/novatest"
  #   chef.validation_client_name = "novatest-validator"
  #   chef.validation_key_path = ".chef/novatest-validator.pem"
  # end
end
